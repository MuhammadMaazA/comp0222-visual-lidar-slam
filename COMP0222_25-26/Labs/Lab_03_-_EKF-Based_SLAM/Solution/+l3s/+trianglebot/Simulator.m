classdef Simulator < ebe.core.EventBasedSimulator
    ...
    % the trianglebot, following a set of waypoints, through an environment
    ...
    methods(Access = public)
        ...
        function obj = Simulator(config)
            ...
            obj.systemModel = l3s.trianglebot.SystemModel(config, config.perturbWithNoise);

            % Instantiate the controller.
            obj.platformController = l3s.trianglebot.WaypointController(obj.config);
        end
